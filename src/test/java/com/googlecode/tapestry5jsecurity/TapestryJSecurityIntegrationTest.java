...
import com.googlecode.tapestry5jsecurity.testapp.services.impl.Invoker;
...
public class TapestryJSecurityIntegrationTest extends AbstractIntegrationTestSuite {
	...
	protected void assertLoginPage() {
		...
		assertEquals("password", getAttribute("jsecPassword@type"), "Page does not containt password field. Not login page.");
		assertEquals("checkbox",  getAttribute("jsecRememberMe@type"), "Page does containt rememberMe field. Not login page.");
		
		String[] buttons = getAllButtons();
		
		assertTrue(ArrayUtils.contains(buttons, "jsecEnter"), "Page not containt login form submit button. Not login page.");
	}
