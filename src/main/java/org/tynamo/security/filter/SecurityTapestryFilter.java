...
/**
 * Filter extending SecurityFilter and provide  {@link TapestryIniWebConfiguration}.
 * <p/>
 ...
 */
public class SecurityTapestryFilter extends ShiroFilter
{

	private static final Logger logger = LoggerFactory.getLogger(SecurityTapestryFilter.class);

	private static final String KEY_PREFIX = SecurityTapestryFilter.class.getSimpleName() + ":";

	private static final String GLOBAL_PROPERTY_PREFIX = "shiro";

	public SecurityTapestryFilter()
	{
	 ...
	 *
	 * @see org.apache.shiro.web.servlet.ShiroFilter#onFilterConfigSet()
	 */
	@Override
	...
	private void savePropertiesToContext(IniResource iniResource)
	{
		...
		savePropertyToContext(filters, SecurityModule.LOGIN_URL_PROPERTY_NAME);
		savePropertyToContext(filters, SecurityModule.SUCCESS_URL_PROPERTY_NAME);
		savePropertyToContext(filters, SecurityModule.UNAUTHORIZED_URL_PROPERTY_NAME);
	}
